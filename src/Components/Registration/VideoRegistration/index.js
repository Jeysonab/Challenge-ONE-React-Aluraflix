...
const RegistroVideo = () => {
	...
	const mensajesError = [
		"",
		"El título debe tener al menos 2 carácteres",
		"El título no puede ser mayor a 30 carácteres",
	];
	...
	const enlaceError = [
		"",
		"El enlace debe tener al menos un signo . y un signo /",
		"El enlace no puede ser menor a 3 carácteres",
		"El enlace debe ser de youtube",
		"El link de youtube está incompleto",
	];
	...
	const descripcionError = [
		"",
		"La descripción debe tener más de 7 o más carácteres",
		"La descripción no puede superar los 300 carácteres",
	];
	...
	const codigoError = [
		"",
		"El código debe ser de 3 o más carácteres",
		"El código debe incluir el signo # seguido de letrás y/o números",
	];
					...
					<DivBtnSo>
						<Link to="/new-category">
							<Button
								...
								backGround={"#2A7AE4"}></Button>
						</Link>
					</DivBtnSo>
				</DivBotones>
				{showPopup && (
					<Succes message={showMessage} onClose={handleClosePopup} />
				)}
			</form>
		</>
	);
